...
const serviceFormSchema = z.object({
  ...
  department: z.enum(['TI'], {
    errorMap: () => ({ message: 'Selecione um tipo de departamento válido.' }),
  }),
  ...
  return (
    <div className="w-full max-h-screen flex overflow-hidden">
      ...
      <main className="w-full flex flex-col items-center justify-start">
        ...
        <div className="w-full h-screen max-w-6xl flex flex-col items-center justify-center p-3">
          <div className="w-full bg-white p-16">
            ...
            >
              ...
              <input
                type="text"
                className="bg-zinc-100 border-[2px] border-zinc-400 rounded-lg p-2 w-72"
                {...register('problem')}
              />
