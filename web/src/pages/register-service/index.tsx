...
export default function RegisterService() {
  ...
  const { mutateAsync: createJobtFn } = useMutation({
  ...
  const selectedDepartmentData =
    services &&
    services.find((department) => department.id === selectedDepartment);

  async function handleCreateService(data: ServiceFormData) {
    try {
      const job = await createJobtFn(data);
          ...
          >
            ...
            >
              ...
              {selectedDepartmentData &&
                selectedDepartmentData.services.map((service) => (
