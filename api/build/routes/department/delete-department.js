...
var delete_department_exports = {};
__export(delete_department_exports, {
  deleteDepartmentHandler: () => deleteDepartmentHandler
});
module.exports = __toCommonJS(delete_department_exports);
...
var paramsSchema = import_zod.default.object({
  departmentId: import_zod.default.string({ message: "Id is invalid" }).uuid({ message: "Id is invalid" })
});
